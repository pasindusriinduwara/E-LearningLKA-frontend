    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="relative w-full max-w-md">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#4f6df5]/20 focus:border-[#4f6df5]"
        />
      </div>
